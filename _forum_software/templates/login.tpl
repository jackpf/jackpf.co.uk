...
<div class="f_header2">
	...
	<div id="register" class="box" style="display: none;">
		...
		<br />
		<a href="<?=$globals->_SERVER['PHP_SELF']?>?action=register&amp;status=help&amp;help=details">Request Details</a>
		<br />
					...
					case 'failure':
						$message .= '<li style="color: red;">
							...
							switch($vars->failure_type):
								case 'credentials':
									$message .= 'unknown/bad credentials.';
								break;
								case 'inactive':
									$message .= 'your account is inactive/suspended.';
