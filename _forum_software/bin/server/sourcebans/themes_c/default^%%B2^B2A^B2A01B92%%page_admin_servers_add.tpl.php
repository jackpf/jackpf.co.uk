<?php /* Smarty version 2.6.20, created on 2010-08-16 12:11:13
         compiled from page_admin_servers_add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'help_icon', 'page_admin_servers_add.tpl', 12, false),array('function', 'sb_button', 'page_admin_servers_add.tpl', 111, false),)), $this); ?>
...
Enabled</div>
		...
		<tr>
			<td valign="middle">
				<div class="rowdesc"><?php echo smarty_function_help_icon(array('title' => 'Server Groups','message' => "Choose a group to add this server to. Server groups are used for adding admins to specific sets of servers."), $this);?>
Server Groups </div>
			</td>
		    <td>&nbsp;</td>
		</tr>
...
" name="groups[]" /> 
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['edit_server']): ?>
				<?php echo smarty_function_sb_button(array('text' => $this->_tpl_vars['submit_text'],'class' => 'ok','id' => 'aserver','submit' => true), $this);?>
