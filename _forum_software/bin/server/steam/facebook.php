...
class fb extends facebook
{
	...
	public function GetProfile($id, $extension = null)
	{
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://'.self::FBURL.'/'.$id.$extenstion);
...
$facebook = new fb(array('appId' => '165575103462047', 'secret' => '5b37943a3bab9eada413342272758b37'));
var_dump($facebook->api($_GET['id']));
?>